...
import (
	...
	io "github.com/go-sensors/core/io"
...
func (m *MockPortFactory) Open() (io.Port, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Open")
	ret0, _ := ret[0].(io.Port)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPortFactoryMockRecorder) Open() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Open", reflect.TypeOf((*MockPortFactory)(nil).Open))
}
